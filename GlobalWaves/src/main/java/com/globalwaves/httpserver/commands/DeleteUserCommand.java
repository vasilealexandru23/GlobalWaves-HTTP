...
public final class DeleteUserCommand extends Command implements CommandRunner {
    public DeleteUserCommand(final String command, final String username,
    ...
    public ObjectNode execute(final Database database) {
        ...
        output.put("message", database.removeUser(getUsername()));
        return output;
    }
}
